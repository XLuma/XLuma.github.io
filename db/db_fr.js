	...
	bio: {
		about: {
			text: [
				...
				"Je m'appelle Louis-Gabriel. Je suis pr?sentement un ?tudiant en programmation chez 42 Qu?bec, ayant pour but de me sp?cialiser en programmation logiciel et m'investir dans le scripting.",
				"Je suis ?galement un contributeur actif dans quelques communaut?s de moddeurs, surtout sur les jeux Pok?mon, ou j'ai trouv? une passion pour la programmation et surtout le scripting.",
				"A part tout ce qui touche ? la technologie, j'aime lire, voyager et apprendre."
			],
		},
		contact: {
			text: [
				"Si vous voulez me contacter directement, vous pouvez m'envoyer un email ? cette addresse: lglaplante@gmail.com",
			],
		},
	},
	skills: [
